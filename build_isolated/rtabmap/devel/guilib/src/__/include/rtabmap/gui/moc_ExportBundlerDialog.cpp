...
void rtabmap::ExportBundlerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ExportBundlerDialog::configChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject rtabmap::ExportBundlerDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rtabmap__ExportBundlerDialog.data,
      qt_meta_data_rtabmap__ExportBundlerDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
