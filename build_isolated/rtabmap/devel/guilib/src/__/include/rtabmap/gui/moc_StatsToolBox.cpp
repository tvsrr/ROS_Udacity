...
void rtabmap::StatItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatItem::valueAdded)) {
                *result = 0;
            }
        }
        {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatItem::valuesChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (StatItem::*_t)(const StatItem * , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatItem::plotRequested)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject rtabmap::StatItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rtabmap__StatItem.data,
      qt_meta_data_rtabmap__StatItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void rtabmap::StatsToolBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatsToolBox::menuChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (StatsToolBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatsToolBox::figuresSetupChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject rtabmap::StatsToolBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rtabmap__StatsToolBox.data,
      qt_meta_data_rtabmap__StatsToolBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
