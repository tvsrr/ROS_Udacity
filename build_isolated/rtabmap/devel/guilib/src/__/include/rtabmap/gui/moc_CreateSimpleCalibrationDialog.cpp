...
const QMetaObject rtabmap::CreateSimpleCalibrationDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rtabmap__CreateSimpleCalibrationDialog.data,
      qt_meta_data_rtabmap__CreateSimpleCalibrationDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *rtabmap::CreateSimpleCalibrationDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rtabmap__CreateSimpleCalibrationDialog.stringdata0))
        return static_cast<void*>(const_cast< CreateSimpleCalibrationDialog*>(this));
