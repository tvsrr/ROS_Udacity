...
class OdomInfo(genpy.Message):
  _md5sum = "9a9c97dc6c27f8a4f2a53d9cd23d41d7"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.localBundleAvgInlierDistance is None:
        self.localBundleAvgInlierDistance = 0.
      if self.localBundleMaxKeyFramesForInlier is None:
        self.localBundleMaxKeyFramesForInlier = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6i2fiB5fi2f().pack(_x.features, _x.localMapSize, _x.localScanMapSize, _x.localKeyFrames, _x.localBundleOutliers, _x.localBundleConstraints, _x.localBundleTime, _x.localBundleAvgInlierDistance, _x.localBundleMaxKeyFramesForInlier, _x.keyFrameAdded, _x.timeEstimation, _x.timeParticleFiltering, _x.stamp, _x.interval, _x.distanceTravelled, _x.memoryUsage, _x.gravityRollError, _x.gravityPitchError))
...
def _get_struct_4d():
    ...
    return _struct_4d
_struct_6i2fiB5fi2f = None
def _get_struct_6i2fiB5fi2f():
    global _struct_6i2fiB5fi2f
    if _struct_6i2fiB5fi2f is None:
        _struct_6i2fiB5fi2f = struct.Struct("<6i2fiB5fi2f")
    return _struct_6i2fiB5fi2f
_struct_9d = None
def _get_struct_9d():
    global _struct_9d
