...
(cl:defmethod cl:initialize-instance :after ((m <EnvSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnvSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_msgs-msg:<EnvSensor> is deprecated: use rtabmap_msgs-msg:EnvSensor instead.")))
...
(cl:defmethod value-val ((m <EnvSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_msgs-msg:value-val is deprecated.  Use rtabmap_msgs-msg:value instead.")
  (value m))
