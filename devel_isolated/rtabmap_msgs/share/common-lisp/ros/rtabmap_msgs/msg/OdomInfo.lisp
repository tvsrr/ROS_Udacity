...
(cl:defclass <OdomInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (localBundleAvgInlierDistance
    :reader localBundleAvgInlierDistance
    :initarg :localBundleAvgInlierDistance
    :type cl:float
    :initform 0.0)
   (localBundleMaxKeyFramesForInlier
    :reader localBundleMaxKeyFramesForInlier
    :initarg :localBundleMaxKeyFramesForInlier
    :type cl:integer
    :initform 0)
   (keyFrameAdded
...
(cl:ensure-generic-function 'localBundleAvgInlierDistance-val :lambda-list '(m))
(cl:defmethod localBundleAvgInlierDistance-val ((m <OdomInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_msgs-msg:localBundleAvgInlierDistance-val is deprecated.  Use rtabmap_msgs-msg:localBundleAvgInlierDistance instead.")
  (localBundleAvgInlierDistance m))

(cl:ensure-generic-function 'localBundleMaxKeyFramesForInlier-val :lambda-list '(m))
(cl:defmethod localBundleMaxKeyFramesForInlier-val ((m <OdomInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_msgs-msg:localBundleMaxKeyFramesForInlier-val is deprecated.  Use rtabmap_msgs-msg:localBundleMaxKeyFramesForInlier instead.")
  (localBundleMaxKeyFramesForInlier m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <OdomInfo>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'localBundleTime))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'localBundleAvgInlierDistance))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let* ((signed (cl:slot-value msg 'localBundleMaxKeyFramesForInlier)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <OdomInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'covariance)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'localBundleAvgInlierDistance) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'localBundleMaxKeyFramesForInlier) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<OdomInfo>)))
  ...
  "9a9c97dc6c27f8a4f2a53d9cd23d41d7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'OdomInfo)))
  "Returns md5sum for a message object of type 'OdomInfo"
  "9a9c97dc6c27f8a4f2a53d9cd23d41d7")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <OdomInfo>))
  ...
  (cl:list 'OdomInfo
    ...
    (cl:cons ':localBundleAvgInlierDistance (localBundleAvgInlierDistance msg))
    (cl:cons ':localBundleMaxKeyFramesForInlier (localBundleMaxKeyFramesForInlier msg))
