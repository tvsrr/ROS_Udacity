...
class OdomInfo {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.localBundleAvgInlierDistance = null;
      this.localBundleMaxKeyFramesForInlier = null;
      ...
      if (initObj.hasOwnProperty('localBundleAvgInlierDistance')) {
        this.localBundleAvgInlierDistance = initObj.localBundleAvgInlierDistance
      }
      else {
        this.localBundleAvgInlierDistance = 0.0;
      }
      if (initObj.hasOwnProperty('localBundleMaxKeyFramesForInlier')) {
        this.localBundleMaxKeyFramesForInlier = initObj.localBundleMaxKeyFramesForInlier
      }
      else {
        this.localBundleMaxKeyFramesForInlier = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [localBundleAvgInlierDistance]
    bufferOffset = _serializer.float32(obj.localBundleAvgInlierDistance, buffer, bufferOffset);
    // Serialize message field [localBundleMaxKeyFramesForInlier]
    bufferOffset = _serializer.int32(obj.localBundleMaxKeyFramesForInlier, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [localBundleAvgInlierDistance]
    data.localBundleAvgInlierDistance = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [localBundleMaxKeyFramesForInlier]
    data.localBundleMaxKeyFramesForInlier = _deserializer.int32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '9a9c97dc6c27f8a4f2a53d9cd23d41d7';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.localBundleAvgInlierDistance !== undefined) {
      resolved.localBundleAvgInlierDistance = msg.localBundleAvgInlierDistance;
    }
    else {
      resolved.localBundleAvgInlierDistance = 0.0
    }

    if (msg.localBundleMaxKeyFramesForInlier !== undefined) {
      resolved.localBundleMaxKeyFramesForInlier = msg.localBundleMaxKeyFramesForInlier;
    }
    else {
      resolved.localBundleMaxKeyFramesForInlier = 0
    }
