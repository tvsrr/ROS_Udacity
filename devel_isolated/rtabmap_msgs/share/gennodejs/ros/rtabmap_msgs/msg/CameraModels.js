...
class CameraModels {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CameraModels
    ...
    obj.models.forEach((val) => {
      bufferOffset = CameraModel.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CameraModels
    let len;
    let data = new CameraModels(null);
    // Deserialize message field [models]
    // Deserialize array length for message field [models]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.models = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.models[i] = CameraModel.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.models.forEach((val) => {
      length += CameraModel.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'rtabmap_msgs/CameraModels';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'b9cc1f538c510301e1a2175d9d0ad481';
  }
