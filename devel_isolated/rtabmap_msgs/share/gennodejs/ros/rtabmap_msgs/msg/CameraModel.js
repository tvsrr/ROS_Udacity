...
class CameraModel {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('local_transform')) {
        ...
        this.local_transform = new geometry_msgs.msg.Transform();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CameraModel
    ...
    bufferOffset = geometry_msgs.msg.Transform.serialize(obj.local_transform, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CameraModel
    let len;
    let data = new CameraModel(null);
    ...
    data.local_transform = geometry_msgs.msg.Transform.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CameraModel(null);
    ...
    if (msg.local_transform !== undefined) {
      resolved.local_transform = geometry_msgs.msg.Transform.Resolve(msg.local_transform)
    }
    else {
      resolved.local_transform = new geometry_msgs.msg.Transform()
    }
