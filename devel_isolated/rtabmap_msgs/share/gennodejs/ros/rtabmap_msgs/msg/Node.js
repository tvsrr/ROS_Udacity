...
class Node {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.label = null;
      this.pose = null;
      this.word_id_keys = null;
      this.word_id_values = null;
      this.word_kpts = null;
      this.word_pts = null;
      this.word_descriptors = null;
      this.data = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('word_id_keys')) {
        this.word_id_keys = initObj.word_id_keys
      }
      else {
        this.word_id_keys = [];
      }
      if (initObj.hasOwnProperty('word_id_values')) {
        this.word_id_values = initObj.word_id_values
      }
      else {
        this.word_id_values = [];
      }
      if (initObj.hasOwnProperty('word_kpts')) {
        this.word_kpts = initObj.word_kpts
      }
      else {
        this.word_kpts = [];
      }
      if (initObj.hasOwnProperty('word_pts')) {
        this.word_pts = initObj.word_pts
      }
      else {
        this.word_pts = [];
      }
      if (initObj.hasOwnProperty('word_descriptors')) {
        this.word_descriptors = initObj.word_descriptors
      }
      else {
        this.word_descriptors = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [word_id_keys]
    bufferOffset = _arraySerializer.int32(obj.word_id_keys, buffer, bufferOffset, null);
    // Serialize message field [word_id_values]
    bufferOffset = _arraySerializer.int32(obj.word_id_values, buffer, bufferOffset, null);
    // Serialize message field [word_kpts]
    // Serialize the length for message field [word_kpts]
    bufferOffset = _serializer.uint32(obj.word_kpts.length, buffer, bufferOffset);
    obj.word_kpts.forEach((val) => {
      bufferOffset = KeyPoint.serialize(val, buffer, bufferOffset);
    });
    // Serialize message field [word_pts]
    // Serialize the length for message field [word_pts]
    bufferOffset = _serializer.uint32(obj.word_pts.length, buffer, bufferOffset);
    obj.word_pts.forEach((val) => {
      bufferOffset = Point3f.serialize(val, buffer, bufferOffset);
    });
    // Serialize message field [word_descriptors]
    bufferOffset = _arraySerializer.uint8(obj.word_descriptors, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [word_id_keys]
    data.word_id_keys = _arrayDeserializer.int32(buffer, bufferOffset, null)
    // Deserialize message field [word_id_values]
    data.word_id_values = _arrayDeserializer.int32(buffer, bufferOffset, null)
    // Deserialize message field [word_kpts]
    // Deserialize array length for message field [word_kpts]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.word_kpts = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.word_kpts[i] = KeyPoint.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [word_pts]
    // Deserialize array length for message field [word_pts]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.word_pts = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.word_pts[i] = Point3f.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [word_descriptors]
    data.word_descriptors = _arrayDeserializer.uint8(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.word_id_keys.length;
    length += 4 * object.word_id_values.length;
    length += 28 * object.word_kpts.length;
    length += 12 * object.word_pts.length;
    length += object.word_descriptors.length;
  ...
  static Resolve(msg) {
    ...
    if (msg.word_id_keys !== undefined) {
      resolved.word_id_keys = msg.word_id_keys;
    }
    else {
      resolved.word_id_keys = []
    }

    if (msg.word_id_values !== undefined) {
      resolved.word_id_values = msg.word_id_values;
    }
    else {
      resolved.word_id_values = []
    }

    if (msg.word_kpts !== undefined) {
      resolved.word_kpts = new Array(msg.word_kpts.length);
      for (let i = 0; i < resolved.word_kpts.length; ++i) {
        resolved.word_kpts[i] = KeyPoint.Resolve(msg.word_kpts[i]);
      }
    }
    else {
      resolved.word_kpts = []
    ...
    if (msg.word_pts !== undefined) {
      resolved.word_pts = new Array(msg.word_pts.length);
      for (let i = 0; i < resolved.word_pts.length; ++i) {
        resolved.word_pts[i] = Point3f.Resolve(msg.word_pts[i]);
      }
    }
    else {
      resolved.word_pts = []
    ...
    if (msg.word_descriptors !== undefined) {
      resolved.word_descriptors = msg.word_descriptors;
    }
    else {
      resolved.word_descriptors = []
    }
