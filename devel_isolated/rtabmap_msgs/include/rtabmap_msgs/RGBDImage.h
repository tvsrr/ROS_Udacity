// Generated by gencpp from file rtabmap_msgs/RGBDImage.msg
// DO NOT EDIT!


#ifndef RTABMAP_MSGS_MESSAGE_RGBDIMAGE_H
#define RTABMAP_MSGS_MESSAGE_RGBDIMAGE_H
...
struct RGBDImage_
{
  ...
  _depth_compressed_type depth_compressed;
   ...
   typedef std::vector< ::rtabmap_msgs::KeyPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rtabmap_msgs::KeyPoint_<ContainerAllocator> >::other >  _key_points_type;
  _key_points_type key_points;

   typedef std::vector< ::rtabmap_msgs::Point3f_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rtabmap_msgs::Point3f_<ContainerAllocator> >::other >  _points_type;
  _points_type points;
  ...
  typedef boost::shared_ptr< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> const> ConstPtr;

}; // struct RGBDImage_

typedef ::rtabmap_msgs::RGBDImage_<std::allocator<void> > RGBDImage;

typedef boost::shared_ptr< ::rtabmap_msgs::RGBDImage > RGBDImagePtr;
typedef boost::shared_ptr< ::rtabmap_msgs::RGBDImage const> RGBDImageConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rtabmap_msgs::RGBDImage_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rtabmap_msgs::RGBDImage_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xaffef6cc8804ffbaULL;
  static const uint64_t static_value2 = 0x98ce6ed6f1ca8942ULL;
};

template<class ContainerAllocator>
struct DataType< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rtabmap_msgs::RGBDImage_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rtabmap_msgs::RGBDImage_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RTABMAP_MSGS_MESSAGE_RGBDIMAGE_H
