// Generated by gencpp from file rtabmap_msgs/GetMapResponse.msg
// DO NOT EDIT!


#ifndef RTABMAP_MSGS_MESSAGE_GETMAPRESPONSE_H
#define RTABMAP_MSGS_MESSAGE_GETMAPRESPONSE_H
...
struct GetMapResponse_
{
  ...
  (void)_alloc;
   ...
   typedef  ::rtabmap_msgs::MapData_<ContainerAllocator>  _data_type;
  _data_type data;
  ...
  typedef boost::shared_ptr< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetMapResponse_

typedef ::rtabmap_msgs::GetMapResponse_<std::allocator<void> > GetMapResponse;

typedef boost::shared_ptr< ::rtabmap_msgs::GetMapResponse > GetMapResponsePtr;
typedef boost::shared_ptr< ::rtabmap_msgs::GetMapResponse const> GetMapResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rtabmap_msgs::GetMapResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x76e7e98705d08082ULL;
  static const uint64_t static_value2 = 0x2083ef0a96245bb9ULL;
};

template<class ContainerAllocator>
struct DataType< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rtabmap_msgs::GetMapResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rtabmap_msgs::GetMapResponse_<ContainerAllocator>& v)
  {
    s << indent << "data: ";
    s << std::endl;
    Printer< ::rtabmap_msgs::MapData_<ContainerAllocator> >::stream(s, indent + "  ", v.data);
  }
};
...
#endif // RTABMAP_MSGS_MESSAGE_GETMAPRESPONSE_H
