...
struct MapGraph_
{
  ...
  _poses_type poses;
   ...
   typedef std::vector< ::rtabmap_msgs::Link_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rtabmap_msgs::Link_<ContainerAllocator> >::other >  _links_type;
  _links_type links;
