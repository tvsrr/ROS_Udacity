...
struct Node_
{
  ...
  _pose_type pose;
   ...
   typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  _word_id_keys_type;
  _word_id_keys_type word_id_keys;

   typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  _word_id_values_type;
  _word_id_values_type word_id_values;

   typedef std::vector< ::rtabmap_msgs::KeyPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rtabmap_msgs::KeyPoint_<ContainerAllocator> >::other >  _word_kpts_type;
  _word_kpts_type word_kpts;

   typedef std::vector< ::rtabmap_msgs::Point3f_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rtabmap_msgs::Point3f_<ContainerAllocator> >::other >  _word_pts_type;
  _word_pts_type word_pts;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _word_descriptors_type;
