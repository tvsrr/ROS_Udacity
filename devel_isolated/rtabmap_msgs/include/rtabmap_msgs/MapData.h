// Generated by gencpp from file rtabmap_msgs/MapData.msg
// DO NOT EDIT!


#ifndef RTABMAP_MSGS_MESSAGE_MAPDATA_H
#define RTABMAP_MSGS_MESSAGE_MAPDATA_H
...
struct MapData_
{
  ...
  _header_type header;
   ...
   typedef  ::rtabmap_msgs::MapGraph_<ContainerAllocator>  _graph_type;
  _graph_type graph;

   typedef std::vector< ::rtabmap_msgs::Node_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rtabmap_msgs::Node_<ContainerAllocator> >::other >  _nodes_type;
  _nodes_type nodes;
  ...
  typedef boost::shared_ptr< ::rtabmap_msgs::MapData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rtabmap_msgs::MapData_<ContainerAllocator> const> ConstPtr;

}; // struct MapData_

typedef ::rtabmap_msgs::MapData_<std::allocator<void> > MapData;

typedef boost::shared_ptr< ::rtabmap_msgs::MapData > MapDataPtr;
typedef boost::shared_ptr< ::rtabmap_msgs::MapData const> MapDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rtabmap_msgs::MapData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rtabmap_msgs::MapData_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rtabmap_msgs::MapData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rtabmap_msgs::MapData_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rtabmap_msgs::MapData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rtabmap_msgs::MapData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rtabmap_msgs::MapData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rtabmap_msgs::MapData_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rtabmap_msgs::MapData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rtabmap_msgs::MapData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8a55e0977a9f84c5ULL;
  static const uint64_t static_value2 = 0x9a3a4a704094fef1ULL;
};

template<class ContainerAllocator>
struct DataType< ::rtabmap_msgs::MapData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rtabmap_msgs::MapData_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rtabmap_msgs::MapData_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rtabmap_msgs::MapData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rtabmap_msgs::MapData_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "graph: ";
    s << std::endl;
    Printer< ::rtabmap_msgs::MapGraph_<ContainerAllocator> >::stream(s, indent + "  ", v.graph);
    ...
    for (size_t i = 0; i < v.nodes.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::rtabmap_msgs::Node_<ContainerAllocator> >::stream(s, indent + "    ", v.nodes[i]);
    }
  }
};
...
#endif // RTABMAP_MSGS_MESSAGE_MAPDATA_H
