// Generated by gencpp from file rtabmap_msgs/GetMap2Response.msg
// DO NOT EDIT!


#ifndef RTABMAP_MSGS_MESSAGE_GETMAP2RESPONSE_H
#define RTABMAP_MSGS_MESSAGE_GETMAP2RESPONSE_H
...
struct GetMap2Response_
{
  ...
  typedef boost::shared_ptr< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> const> ConstPtr;

}; // struct GetMap2Response_

typedef ::rtabmap_msgs::GetMap2Response_<std::allocator<void> > GetMap2Response;

typedef boost::shared_ptr< ::rtabmap_msgs::GetMap2Response > GetMap2ResponsePtr;
typedef boost::shared_ptr< ::rtabmap_msgs::GetMap2Response const> GetMap2ResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rtabmap_msgs::GetMap2Response_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x76e7e98705d08082ULL;
  static const uint64_t static_value2 = 0x2083ef0a96245bb9ULL;
};

template<class ContainerAllocator>
struct DataType< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rtabmap_msgs::GetMap2Response_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rtabmap_msgs::GetMap2Response_<ContainerAllocator>& v)
  {
    s << indent << "data: ";
    s << std::endl;
...
#endif // RTABMAP_MSGS_MESSAGE_GETMAP2RESPONSE_H
